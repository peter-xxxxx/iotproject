...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly Brush swordBrush = Brushes.Red;
        ...
        private readonly Pen swordPen = new Pen(Brushes.Red, 3);
        ...
        private void DrawBonesAndJoints(Skeleton skeleton, DrawingContext drawingContext)
        {
            ...
            int handY = this.sensor.CoordinateMapper.MapSkeletonPointToDepthPoint(skeleton.Joints[JointType.HandRight].Position, DepthImageFormat.Resolution640x480Fps30).Y;

            drawingContext.DrawEllipse(this.swordBrush, null, new Point(handX + swordX, handY + swordY), JointThickness, JointThickness);
        ...
        private void showDataOnTextbox()
        {
            showData.Text = "22";
        }

        private void showReceivedDataOnTextbox(String z)
        {
            showReceivedData.Text = z;
        }
        ...
        private void ReciveMsg()
        {
            while (true)
            {
                try
                {
                    ...
                    if (pm.GetLength(0) == 4)
                    {
                        this.swordData[0] = Int32.Parse(pm[0]);
                        this.swordData[1] = Int32.Parse(pm[1]);
                        this.swordData[2] = Int32.Parse(pm[2]);
                        this.swordData[3] = Int32.Parse(pm[3]);
                    }
                }
                catch (ThreadAbortException e)
                {
                    this.showReceivedData.Dispatcher.Invoke(new ShowMessageDelegate(ShowMessage), e);
                    break;
                }
            }
        }
